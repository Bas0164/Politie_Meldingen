...
// De ReportWantedAdapter klasse erft van ArrayAdapter en is bedoeld om de lijst van WantedReport objecten weer te geven
class ReportWantedAdapter(context: Context, reports: ArrayList<WantedReport>) : ArrayAdapter<WantedReport>(context, 0, reports) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val report = getItem(position) as WantedReport
