...
class APIController(var context: HomeActivity) {
    ...
    fun listReports(listReports: ListView) {
        ...
        val request = StringRequest(
            ...
            { response ->
                ...
                // Beperk de lengte van de jsonArray tot maximaal 5
                val length = if (jsonArray.length() > 5) 5 else jsonArray.length()
                ...
                val adapter = ReportAdapter(context, ArrayList(reports))
                ...
                listReports.onItemClickListener = AdapterView.OnItemClickListener { adapterView, view, pos, l ->
                    ...
                    // Maak een nieuwe instantie van OverviewDetailFragment
