...
// De ReportOverviewAdapter klasse erft van ArrayAdapter en is bedoeld om de lijst van Report objecten weer te geven
class ReportOverviewAdapter(context: Context, reports: ArrayList<Report>) : ArrayAdapter<Report>(context, 0, reports) {
